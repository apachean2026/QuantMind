...
_FEATURES_DAILY_COLUMN_MAP: dict[str, str] = {
    ...
    # QuantDB 2026-09：未来收益标签 return_Nd → future_return_Nd；API/SDL 仍用 return_*
    "future_return_1d": "return_1d",
    "future_return_3d": "return_3d",
    "future_return_5d": "return_5d",
    "future_return_10d": "return_10d",
    "future_return_20d": "return_20d",
    "future_return_60d": "return_60d",
    "ma5": "ma5",
    "ma10": "ma10",
    "ma20": "ma20",
    "ma60": "ma60",
