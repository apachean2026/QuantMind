...
STOCK_SELECTION_SCHEMA: list[SchemaColumn] = [
    ...
    SchemaColumn("stock_selection", "volume", "成交量（股）"),
    SchemaColumn("stock_selection", "amount", "成交额（万元）"),
...
STOCK_DAILY_SCHEMA: list[SchemaColumn] = [
    ...
    SchemaColumn("stock_daily", "volume", "成交量（股）"),
    SchemaColumn("stock_daily", "amount", "成交额（万元）"),
...
STOCK_DAILY_LATEST_SCHEMA: list[SchemaColumn] = [
    ...
    SchemaColumn("stock_daily_latest", "amount", "成交额（万元）"),
