...
- `indicators`：量纲无关指标——rsi_6/14、kdj_k/d/j、macd_dif/dea/hist、ma_gap_5/10/20（乖离率）、vol_std_5/20/60、vol_atr_14、vol_to_ma5/20、volume_trend_3d、future_return_1d/3d/5d/10d/20d/60d（未来收益标签，分析展示可用，勿作选股过滤）
